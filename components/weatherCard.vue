...
<template>
  <div
    class="min-h-screen flex justify-center items-center bg-gradient-to-br from-[#00b4db] to-[#0083b0] p-5"
  >
    <div class="bg-white/90 rounded-2xl shadow-lg w-full max-w-md">
      <!-- Main Card Content -->
      <div
        class="p-8 cursor-pointer transition-all duration-300 hover:bg-white/95"
        @click="toggleExpand"
      >
        <!-- City and Date -->
          ...
          <div class="flex justify-center items-center gap-8">
            <div class="text-center">
              ...
              <span class="text-4xl font-bold text-gray-800"
                >{{ weatherStore.weatherData.temperature }}°C</span
              >
            </div>
            <div class="text-center">
              <span class="block text-sm text-gray-600">Gece</span>
              <span class="text-4xl font-bold text-gray-800"
                >{{ weatherStore.weatherData.temperature - 5 }}°C</span
              >
            </div>
          </div>
